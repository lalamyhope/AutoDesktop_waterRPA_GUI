...
class CommandMouseClick(QWidget):
    ...
    def __init__(self):
        ...
        self.spinBox_x.setToolTip("X坐标，0=原位")
        ...
        self.spinBox_y.setToolTip("Y坐标，0=原位")
        ...
        self.row1.addWidget(self.spinBox_clicks)

        self.label_6 = QLabel("次，间隔")
        self.row1.addWidget(self.label_6)
        ...
        self.row1.addWidget(self.doubleSpinBox_interval)

        self.label_7 = QLabel("秒")
        self.row1.addWidget(self.label_7)
        ...
        self.toolButton_teach.clicked.connect(
            lambda: _teach_coordinates(self.spinBox_x, self.spinBox_y, self.toolButton_teach))

    def load_args(self, args_dict):
        self.args_dict = dict(args_dict)
        self.comboBox_button.setCurrentText(args_dict["button"])
        self.spinBox_clicks.setValue(args_dict["clicks"])
    ...
    def send_args(self):
        ...
        self.args_dict["clicks"] = self.spinBox_clicks.value()
