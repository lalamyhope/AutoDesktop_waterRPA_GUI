...
class CommandMouseMoveAbsolute(QWidget):
    ...
    def __init__(self):
        ...
        self.label_1 = QLabel("使用")
        self.row1.addWidget(self.label_1)
        ...
        self.row1.addWidget(self.doubleSpinBox_duration)

        self.label_2 = QLabel("秒，移动至坐标轴 (X")
        ...
        self.label_4 = QLabel(")")
        self.row1.addWidget(self.label_4)
    ...
    def load_args(self, args_dict):
        ...
        self.doubleSpinBox_duration.setValue(args_dict["duration"])
        self.spinBox_x.setValue(args_dict["x"])
        self.spinBox_y.setValue(args_dict["y"])
    ...
    def send_args(self):
        self.args_dict["duration"] = self.doubleSpinBox_duration.value()
